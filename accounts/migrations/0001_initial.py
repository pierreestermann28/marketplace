    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trust_score', models.DecimalField(db_index=True, decimal_places=2, default=Decimal('0.00'), max_digits=4)),
            ...
            managers=[
                ('objects', accounts.models.users.EmailUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Address',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('seller_rating_avg', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=3)),
                ('seller_rating_count', models.PositiveIntegerField(default=0)),
                ('buyer_rating_avg', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=3)),
